 ...
 * All rights reserved
********************************************************************************/
const unsigned char* stepLanguage11[3]={
{"潜水"},
{"时间"},
{"确定"},
};
const unsigned char* DiveTimeLang_En[3]={
{"MAX"},
{"DUR"},
{"OK"},
};

void time_ui_new(u8 step)
{
	...
	if(flush_enable == 0)
	{
		...
		{
			Show_Str(x,y,width,high,stepLanguage11[0],16);	
		}
		else
		{
			Show_Str(x,y,width,high,DiveTimeLang_En[1],16);	 
		}
		...
		if( LANGUAGE_CH == m_ConfigParams.m_Language)
		{
			Show_Str(x,y,width,high,stepLanguage11[1],16);	
		}
		else
		{
			Show_Str(x,y,width,high,DiveTimeLang_En[0],16);	 
		}
		x = 76;
		y = 22;
		width = 72;
		...
		if( LANGUAGE_CH == m_ConfigParams.m_Language)
		{
			Show_Str(x,y,width,high,stepLanguage11[2],16);
		}
		else
		{
			Show_Str(x,y,width,high,DiveTimeLang_En[2],16);
		}
		x = 83;		
		y = 53;
		BACK_COLOR = 0x1565;	
...
void time_ui(void)
{
	...
	oled_showPicture(0,0,bmp_max_time,127,63);	
