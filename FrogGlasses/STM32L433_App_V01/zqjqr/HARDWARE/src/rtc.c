...
RTC_TimeTypeDef init_stimestructure;
...
{      
    ...
    { 
        RTC_Set_Time(11,30,56,RTC_HOURFORMAT12_PM);	        //设置时间 ,根据实际时间修改
		RTC_Set_Date(19,2,19,2);		                    //设置日期
        HAL_RTCEx_BKUPWrite(&RTC_Handler,RTC_BKP_DR0,0X5050);//标记已经初始化过了
    }
	
      HAL_RTC_GetTime(&RTC_Handler, &init_stimestructure, RTC_FORMAT_BIN);
